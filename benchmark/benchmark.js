...
bench( format( '%s::order', pkg ), function benchmark( b ) {
	var f;
	var i;
...
bench( format( '%s::order,means', pkg ), function benchmark( b ) {
	var strides;
	var buffer;
	var means;
	var shape;
...
bench( format( '%s::covariance_matrix', pkg ), function benchmark( b ) {
	var strides;
	var buffer;
	var shape;
	var cov;
...
bench( format( '%s::covariance_matrix,means', pkg ), function benchmark( b ) {
	var strides;
	var buffer;
	var shape;
	var means;
